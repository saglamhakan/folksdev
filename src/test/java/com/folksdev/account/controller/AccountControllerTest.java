...
import com.folksdev.account.service.IntegrationTestSupport;
...
@DirtiesContext
class AccountControllerTest extends IntegrationTestSupport { //İntegration test controller katmanında yazılır. Datayı veritabanına kaydedip kaydetmediği kontrol edilir
    ...
    public void testCreateAccount_whenCustomerIdExits_shouldCreateAccountAndReturnAccountDto() throws Exception {
        ...
        CreateAccountRequest request = generateCreateAccountRequest(customer.getCustomerId(), 100);
        ...
        this.mockMvc.perform(post(ACCOUNT_API_ENDPOINT)
                ...
                .andExpect(jsonPath("$.customer.id", is(customer.getCustomerId())))
